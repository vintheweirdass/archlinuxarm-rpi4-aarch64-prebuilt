...
- Download one of the Image (that contains `sdcard.img` on the files) from the [Releases](https://github.com/vintheweirdass/archlinuxarm-rpi4-aarch64-prebuilt) page.
   
<details>
<summary>For compressed files</summary>
...
- Unzip the file you have downloaded until the file format is not `.zip`, `.gz`, `.zst`, or other compressed format
</details>

- Voilà! Now you can use the file (`.img`) to the [Raspberry Pi Imager](https://www.raspberrypi.com/software/)!
